...
export const roadProposal: {
  ...
  intro: {
    es: "Preparamos nuestro primer viaje de college football para contar la experiencia de Navy Football en español e inglés desde la perspectiva de dos aficionados europeos.",
    en: "We are planning our first college football trip to tell the Navy Football experience in Spanish and English from two European fans’ perspective.",
  },
  visit: { es: "Viaje previsto: 23–25 de octubre de 2026 · Dos visitantes", en: "Planned visit: October 23–25, 2026 · Two visitors" },
  ...
  deliverables: [
    ...
    { title: { es: "Artículo bilingüe", en: "Bilingual article" }, text: { es: "Una crónica de la experiencia y una guía práctica para visitantes europeos, en español e inglés.", en: "An experience report and practical guide for European visitors, in Spanish and English." } },
  ],
  ...
  guidance: { es: "También agradeceríamos orientación sobre actividades abiertas a visitantes o una introducción al contacto adecuado.", en: "We would also appreciate guidance on activities open to visitors or an introduction to the appropriate contact." },
